...
func (m *ReviewRequest) GetContextKeys() []string {
	if m != nil {
		return m.ContextKeys
	}
	return nil
...
func (m *ReviewResponse) GetReviews() []*Review {
	if m != nil {
		return m.Reviews
	}
	return nil
...
type Review struct {
	// url to redirect to when an review is clicked.
	RedirectUrl string `protobuf:"bytes,1,opt,name=redirect_url,json=redirectUrl,proto3" json:"redirect_url,omitempty"`
	// short reviewvertisement text to display.
	Text                 string   `protobuf:"bytes,2,opt,name=text,proto3" json:"text,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *Review) GetRedirectUrl() string {
	if m != nil {
		return m.RedirectUrl
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*ReviewRequest)(nil), "hipstershop.ReviewRequest")
	proto.RegisterType((*ReviewResponse)(nil), "hipstershop.ReviewResponse")
	proto.RegisterType((*Review)(nil), "hipstershop.Review")
}
...
type ReviewServiceClient interface {
	GetReviews(ctx context.Context, in *ReviewRequest, opts ...grpc.CallOption) (*ReviewResponse, error)
}
...
func (c *reviewServiceClient) GetReviews(ctx context.Context, in *ReviewRequest, opts ...grpc.CallOption) (*ReviewResponse, error) {
...
type ReviewServiceServer interface {
	GetReviews(context.Context, *ReviewRequest) (*ReviewResponse, error)
}
...
func _ReviewService_GetReviews_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReviewServiceServer).GetReviews(ctx, req.(*ReviewRequest))
	}
	return interceptor(ctx, in, info, handler)
}
